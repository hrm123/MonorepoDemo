...
app.get('/api/groups/:name/participants', async (req, res) => {
  ...
  try {
    ...
    // Baileys' participant list gives phone numbers/LIDs and admin role, not
    // saved contact names — WhatsApp's protocol doesn't expose other users'
    // contact names to you unless you've saved them yourself.
